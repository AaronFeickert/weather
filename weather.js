...
async function getLiveData() {
    // Get the data
    let response = await fetch('https://corsproxy.io/?url=' + encodeURIComponent('http://online.saiawos.com/MSP/ios/webgetjson.php?buster=' + (new Date()).getTime()), { cache: 'reload' });
